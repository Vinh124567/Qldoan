              ...
              <form id="quickForm " method="post" action="dsdetai/xuly.php">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="tendt" class="form-control" id="name" placeholder="Tên đè tài">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Thời gian bắt đầu </label>
                    <input type="text" name="timebd"  class="form-control" id="time" placeholder="VD: 2022-11-21">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Thời gian kết thúc</label>
                    <input type="text" name="timekt" class="form-control" id="name" placeholder="VD: 2023-02-21">
                  </div>
                  <div class="form-group">
